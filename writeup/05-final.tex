...
\subsection{Bluejay ($1200 \times 832$ px)}
\begin{tabular}{l|l|l|l|l|l}
...
\end{tabular}
\subsection{Elephant ($389 \times 584$ px)}
\begin{tabular}{l|l|l|l|l|l}
    Item & C (s) & OMP (s) & Speedup & CUDA (s) & Speedup
\\  \hline
...
\end{tabular}
\subsection{Flower ($2242 \times 2112$ px)}
\begin{tabular}{l|l|l|l|l|l}
    Item & C (s) & OMP (s) & Speedup & CUDA (s) & Speedup
\\  \hline
...
\end{tabular}
\subsection{Large Elephant ($2592 \times 3888$ px)}
\begin{tabular}{l|l|l|l|l|l}
    Item & C (s) & OMP (s) & Speedup & CUDA (s) & Speedup
\\  \hline
...
\end{tabular}
\subsection{Purp ($2944 \times 2609$ px)}
\begin{tabular}{l|l|l|l|l|l}
    Item & C (s) & OMP (s) & Speedup & CUDA (s) & Speedup
\\  \hline
...
\end{tabular}
\subsection{Tiger ($1400 \times 845$ px)}
\begin{tabular}{l|l|l|l|l|l}
    Item & C (s) & OMP (s) & Speedup & CUDA (s) & Speedup
\\  \hline
